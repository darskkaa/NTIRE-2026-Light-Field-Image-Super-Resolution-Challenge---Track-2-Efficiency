"""
MyEfficientLFNet v6.4 - Maximum Quality within 20G FLOPs
=========================================================

FLOPs: ~18-19G (90-95% of 20G budget) ✓
Params: ~700K (70% of 1M budget) ✓

Key V6.4 Optimizations (from V6.3 @ 28.7G → V6.4 @ ~18G):
- UltraEfficientEPI: Spatial dilated conv instead of patch loop (15G → 3G)
- Single EPI branch: Only deep (post-VSSM) processing
- Increased channels: 56 → 64 for higher quality (+3G invested)
- Conv3 MultiScale: All branches use conv3 (faster, similar quality)
- Unified block fusion: Single fusion layer instead of early/late
...
- Dilated convolutions: Capture angular relationships without patch loops
...
try:
    ...
    print("✓ mamba-ssm loaded successfully (V6.4 Max-Quality)")
except ImportError:
    MAMBA_AVAILABLE = False
    raise ImportError(
        "\n" + "="*70 + "\n"
        "❌ CRITICAL ERROR: mamba-ssm is REQUIRED for V6.4!\n"
        "="*70 + "\n\n"
        "Install with:\n"
...
class get_model(nn.Module):
    ...
    Architecture:
        1. Shallow Feature Extraction (64 channels)
        2. SAI Branch: 8× LF-VSSM blocks with Conv3 MultiScale
    ...
    def __init__(self, args):
        ...
        # V6.4 Architecture (Max Quality within budget)
        self.channels = 64      # Increased from 56 for quality
        self.n_blocks = 8       # Keep 8 blocks for quality
        ...
        # ================================================================
        self.block_fusion = nn.Conv2d(self.channels * 8, self.channels, 1, bias=False)
...
if __name__ == "__main__":
    print("=" * 70)
    print("🚀 MyEfficientLFNet v6.4 - Maximum Quality Self-Test")
    print("=" * 70)
    ...
    print(f"   Channels: 64 (vs 56 in V6.3)")
    print(f"   Blocks: 8× LF-VSSM")
    print(f"   EPI: Ultra-efficient dilated (NEW)")
    print(f"   MultiScale: All Conv3")
